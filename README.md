...
| `aspect_ratio`            | `string` | `undefined`                                                                                                | Responsive ratio (e.g. `16:9`, `4:3`, `1:1`, `21:9`, `56.25%`, `50%`).                  |
| `height`                  | `string` | `calc(100dvh - var(--header-height, 64px))`                                                                | Custom CSS height (e.g. `600px`, `80vh`) used when `aspect_ratio` is omitted.           |
| `grid_options`            | `object` | `{columns: "full", rows: 8}`                                                                               | Lovelace Sections grid layout options (`columns`, `rows`, `min_columns`, `min_rows`).   |
